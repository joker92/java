...
import static it.engim.templatedb.OrdineDAO.calcolaPeso;
import it.engim.templatedb.TariffeCorriereDAO;
...
public class TariffeCorriereDAO {
    ...
    public static TariffeCorriere calcolaTariffaMigliore(Ordine o)
    {
        ...
        {
            Query q =
                    em.createNamedQuery("TariffeCorriere.findBest");
            
            Double peso= OrdineDAO.calcolaPeso(o,em);
            q.setParameter("peso",peso);
            q.setMaxResults(1);
            List<TariffeCorriere> result=
                    q.getResultList();
            return result.get(0);
        }
        finally
