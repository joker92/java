...
public class ArticoloModel extends LoadableDetachableModel<Articolo>{

    private int id;
    
    public ArticoloModel(int id)
    {
        this.id= id;
    }
    @Override
    protected Articolo load() 
    {
        ...
        try
        {
            Articolo c = em.find(Articolo.class, id);
             return c;
        }
        finally
        {
